...
if (isset($Confirm)) {   // 確認按鈕
	...
	$sqlcmd = "SELECT count(*) AS c FROM activities WHERE name='$Activityname' AND soft_delete='0'";
    ...
    if (empty($ErrMsg)) {
		...
		$C = $rs[0]['reccount'];
		$C++;
        $sqlcmd="INSERT INTO carousel (name,start_date,end_date) VALUES ('$Activityname','$start_date','$end_date')";
		...
		if ( $_FILES["upfile"]["size"] > 0 ) 
        {
			...
			{
				//$saveto = "../img/".$PLID.".".$src;
				$saveto = "/images/activities/".$C.".png";
